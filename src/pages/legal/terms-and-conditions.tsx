...
const Page: NextPage = () => {
  return (
    ...
    <SiteContainer spacing="l2" blockSpacing="l1">
      ...
      <Block width="small">
        <Text>
          <h1><Heading size="l6" bold="heavy" title="Terms and Conditions" /></h1>
          <Heading title="Last updated: November 02, 2022" />
          <Heading title="Please read these terms and conditions carefully before using Our Service." />
        </Text>
      </Block>

      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="Interpretation and Definitions" /></h2>
          ...
          <List listStyle="bulleted" spacing="l1">
            <li>
      ...
      <Block width="small">  
        <Text>
          <h2><Heading size="l4" bold="heavy" title="Links to Other Websites" /></h2>
      ...
      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="Termination" /></h2>
      ...
      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="Limitation of Liability" /></h2>
      ...
      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="'AS IS' and 'AS AVAILABLE' Disclaimer" /></h2>
          ...
          <p>
            Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable statutory rights of a 
      ...
      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="Governing Law" /></h2>

          <p>
            The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of 
      ...
      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="Disputes Resolution" /></h2>
      ...
      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="For European Union (EU) Users" /></h2>
      ...
      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="Severability and Waiver" /></h2>
          <h3><Heading size="l3" bold="heavy" title="Severability" /></h3>
      ...
      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="Waiver" /></h2>
          ...
          <p>
            ...
            party&apos;s ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver 
      ...
      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="Translation Interpretation" /></h2>
      ...
      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="Changes to These Terms and Conditions" /></h2>
      ...
      <Block width="small">
        <Text>
          <h2><Heading size="l4" bold="heavy" title="Contact Us" /></h2>

          <p>
            If you have any questions about these Terms and Conditions, You can contact us by email: evanmeador519@gmail.com.
          </p>
        </Text>
      </Block>
    </SiteContainer>
