  ...
  return (
    ...
    <SiteContainer spacing="l2" blockSpacing="l1">
      ...
      <Block width="medium">
        ...
        <div>Please read these terms and conditions carefully before using Our Service.</div>
      </Block>
      ...
      <Block width="medium">
        <Text>
          ...
          <h2><Heading size="l4" bold="heavy" title="Definitions" /></h2>
        ...
        <li>
        <p><strong>Website</strong> refers to Continuum Capital, accessible from <a href="www.continuum.io" rel="external nofollow noopener" target="_blank">www.continuum.io</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: evanmeador519@gmail.com</li>
        </ul>
      </Block>
    </SiteContainer>
